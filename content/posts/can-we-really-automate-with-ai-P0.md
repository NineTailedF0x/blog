...
Every week it's the same headline: AI this, AI that, capped off with "Cybersecurity is DEAD, AI will replace it in X years!!!!" Im calling BS, but instead of just ranting into the void, I want to actually break it down: whats doable right now, whats not. And, of course, why we are far off from AI replacing <span class="gloss" tabindex="0" data-tip="mostly about web pentesters here, since thats my job">pentesters</span>.
